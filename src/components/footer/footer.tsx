...
export default function Footer(){
  ...
  const menuEntries = Object.entries(sideItems).filter(([key]) => key !== "title");
    return(
        <footer className="w-full border bg-background/95 backdrop-blur-sm mt-0">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="GitHub" href="https://github.com/syllaaboubacar">
                  ...
                  <svg data-prefix="fab" data-icon="square-github" className="svg-inline--fa fa-square-github h-8 w-8 text-primary" role="img" viewBox="0 0 448 512" aria-hidden="true">
                ...
                <a target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="LinkedIn" href="https://www.linkedin.com/in/sylla-aboubacar-ba033312b">
                  <svg data-prefix="fab" data-icon="linkedin" className="svg-inline--fa fa-linkedin h-8 w-8 text-primary" role="img" viewBox="0 0 448 512" aria-hidden="true">
                ...
                <a className="text-muted-foreground hover:text-primary transition-colors" aria-label="Facebook" href="mailto:contact@syllaaboubacar.com">
                  <svg data-prefix="fab" data-icon="square-facebook" className="svg-inline--fa fa-square-facebook h-8 w-8 text-primary" role="img" viewBox="0 0 448 512" aria-hidden="true">
          ...
          <div className="mt-8 pt-6 border-t text-center text-sm text-muted-foreground flex flex-col sm:flex-row justify-between items-center gap-2">
        		<p>{DataText.footer.copyright}</p>
        		<p className="flex items-center gap-1">{DataText.footer.comment}</p>
        	</div>
